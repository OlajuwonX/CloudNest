...
export default function SplashScreen2() {
  ...
  return (
    ...
    >
      ...
      >
        <View className="self-center bg-[rgba(56,224,118,0.3)] border border-[rgba(74,222,128,0.45)] rounded-full px-[14px] py-[5px] mb-5">
          <Text className="text-[#83e169] text-[13px] font-semibold tracking-[0.4px]">
            ☁ CloudNest
          </Text>
        </View>
